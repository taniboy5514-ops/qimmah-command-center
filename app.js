...
function viewOverview() {
  ...
  <div class="grid stats">
    <div class="stat"><div class="lbl">Income this month</div><div class="val green">OMR ${fmt(inc)}</div><div class="sub">expenses: OMR ${fmt(monthExpense())}</div></div>
    ...
    <div class="stat"><div class="lbl">Active agents</div><div class="val violet">60<span style="font-size:14px;color:var(--dim)">/60</span></div><div class="sub">${SQUADS.map(s => s[0]).join(" · ")} — 5 squads online</div></div>
...
function render() {
  ...
  v.innerHTML = { overview: viewOverview, brain: viewBrain, ceo: viewCEO, finance: viewFinance, pipeline: viewPipeline, tasks: viewTasks, settings: viewSettings }[activeTab]();
  bind();
  const box = document.getElementById("chatBox");
